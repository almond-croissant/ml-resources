# ML Self-Study Resources

Welcome to my ML learning journey! This repo contains all the resources, notes, and code I'm using to learn Machine Learning.

### YouTube

- [StatQuest with Josh Starmer](https://youtube.com/c/joshstarmer)
- [3Blue1Brown](https://youtube.com/3blue1brown)
- [Andrej Karpathy](https://youtube.com/@andrejkarpathy)

### Books (local copies in `/books`)
